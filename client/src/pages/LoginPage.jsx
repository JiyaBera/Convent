...
export default function LoginPage() {
  ...
  return (
    <div className="bg-primaryBg min-h-screen w-full flex justify-between items-center">

      <div className="bg-ex2 w-full sm:w-full ml-20 md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl justify-center align-middle">
        ...
        <form className="flex flex-col w-auto items-center" onSubmit={loginUser}>
          ...
          <div className="input">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-fontprimary">
            ...
            <input type="email" placeholder="Email" className="input-et text-fontprimary" value={email} onChange={ev => setEmail(ev.target.value)} />
          </div>
